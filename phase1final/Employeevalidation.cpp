...
bool Employeevalidation::checkName(string n){
      bool x = false;
...
bool Employeevalidation::checkPassword(string p){
      bool x = false;
         if (p.size() < 8){
...
bool Employeevalidation::checkSalary(double s){
    if (s < 5000){
...
bool Employeevalidation::checkBalance(double b){
  return true;
}
